...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="form-group">
            <div class="col-sm-4"><i class="glyphicon glyphicon-list-alt"></i> Add Registro Célula/ <a href="<?php echo URL; ?>controle-home/index">Home</a></div>
...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" id="form_cadregcelula">
            <div class="form-group">
                <div class="col-sm-4">
                    <label for="regcelceluladescricao" class=" control-label"><span style="color: red">* </span>Célula:</label>
                    <input type="text" readonly="true" class="form-control" id="regcelceluladescricao">
                    <input type="hidden" required="required" readonly="true" class="form-control" id="regcelcelulacod">
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                <div class="col-sm-6">
                    ...
                    <input type="text" readonly="true" class="form-control" id="regcellider">
                </div>
                <div class="col-sm-4">
                    <label for="regcelgrupo" class=" control-label"><span style="color: red">* </span>Grupo:</label>
                    <input type="text" readonly="true" class="form-control" id="regcelgrupo">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-4">
            ...
            <div class="form-group">  
                <div class="col-sm-4">
                    ...
                    <input type="date" required="required"  value="<?= $date ?>"  class="form-control" id="regceldata_registro" readonly="true">
                </div>
                <div class="col-sm-4">
                    <label for="regceldata_realizacao" class=" control-label"><span style="color: red">* </span>Data Realização:</label>
                    <input type="date" required="required" value="<?= $date ?>"  class="form-control" id="regceldata_realizacao" >
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-3">
                    <label for="regcelqtd_participantes" class=" control-label">Quant. Participantes:</label>
                    <input class="form-control" type="number" value="0" id="regcelqtd_participantes">               
                </div>
                <div class="col-sm-3">
                    <label for="regcelqtd_conversoes" class=" control-label"><span style="color: red">* </span>Quant. Conversões:</label>
                    <input class="form-control" type="number" value="0" id="regcelqtd_conversoes">               
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-4">
                    <label for="regcelvalor" class=" control-label">Oferta:</label>
                    <input type="text"  required="required" class="form-control" id="regcelvalor" ata-thousands="." data-decimal="," data-prefix="R$ " >                   
                </div>
            </div>
...
<script src="<?php echo URL; ?>assets/js/RegCelula4.js"></script>
