<div class="panel panel-default">
    <div class="panel-body">
        ...
        <i class="glyphicon glyphicon-list-alt"></i> Registros Dízimos       
    </div>
</div>

<ul class="nav nav-tabs">
    <li class="active"><a href="<?php echo URL; ?>controle-regdizimo/index">Dízimo</a></li>
    <li><a href="<?php echo URL; ?>controle-regculto/index">Culto</a></li>
    <li><a href="<?php echo URL; ?>controle-regcelula/index">Célula</a></li>
</ul>
<br>
<div class="col-sm-12">
    <div class="col-sm-3"><a href="<?php echo URL; ?>controle-regdizimo/cadastrarRegDizimo" style="width: 90px; height: 30px; font-size: 12px" type="button" class="btn btn-primary">Adicionar</a></div>
    <form action="<?php echo URL; ?>controle-regdizimo/index" method="POST"> 
...
<div class="col-sm-9">
    ...
    <table id="tab_dizimo" class="display" style="width:100%">
        ...
        <tbody>
            ...
            <?php
            foreach ($this->Dados as $regdizimo) {
                ?>

                <tr>
                    <td><?= $regdizimo['dizcod'] ?></td>
                    <td><?= $regdizimo['dizdata'] ?></td>
                    <td><?= number_format($regdizimo['dizvalor'], 2, ",", ".") ?></td>
                    <td><?= $regdizimo['memnome'] ?></td>
                    <td><?= $regdizimo['fordescricao'] ?></td>

                    <td>
                        <a href="<?php echo URL; ?>controle-regdizimo/visualizar/<?php echo $regdizimo['dizcod']; ?>"><img src="<?php echo URL; ?>/assets/image/editar_1.png" alt=""/></a>             
                    </td>
                    <td>
                        <a href="" onclick="excluir('<?= $regdizimo['dizcod'] ?>')" id="bt-excluir"><img src="<?php echo URL; ?>/assets/image/delete_1.png" alt=""/></a>
                    </td>
...
<div class="col-sm-3" style="background-color: white; border: 1px solid; border-color: #31b0d5; border-radius: 10px">
    ...
    <table class="table col-sm-12">
        ...
        <tr>
            <td><h5>Culto</h5></td>
            <td></td>
            <td><h5><?php echo "R$ " . number_format($this->Dados_editar['valorTotalculto'][0]['sum(regculvalor)'], 2, ",", ".") ?></h5></td>
        </tr>
        <tr>
