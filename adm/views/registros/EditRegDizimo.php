...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" id="form_editregdizimo">
            <div class="form-group">  
                <div class="col-sm-4">
  
                    <label for="regdizdata" class=" control-label"><span style="color: red">* </span>Data:</label>
                    <input type="date" required="required" value="<?php echo $this->Dados[0]['dizdata']?>"  class="form-control" id="regdizdata" readonly="true">
                     <input type="hidden"  value="<?php echo $this->Dados[0]['dizcod']?>" required="required" readonly="true" class="form-control" id="dizcod">
                </div>
                <div class="col-sm-4">
                    ...
                    <select id="regdizformapag" class="form-control">
                        <option value="<?php echo $this->Dados[0]['forcod']?>"><?php echo $this->Dados[0]['fordescricao']?></option>
                        <?php
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    ...
                    <input type="text" value="<?php echo $this->Dados[0]['dizvalor']?>" readonly="true" required="required" class="form-control" id="regdizvalor" ata-thousands="." data-decimal="," data-prefix="R$ " >                   
                </div>
                <div class="col-sm-4">
                    <label for="regdizmemnome" class=" control-label"><span style="color: red">* </span>Membro:</label>
                    <input type="text" value="<?php echo $this->Dados[0]['memnome']?>"  readonly="true" class="form-control" id="regdizmemnome">
                    <input type="hidden"  value="<?php echo $this->Dados[0]['memcod']?>" required="required" readonly="true" class="form-control" id="regdizmemcod">
                </div>
                <div class="col-sm-4">
