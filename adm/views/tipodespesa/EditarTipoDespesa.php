...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" id="form_edittipodespesa">
            <div class="form-group">
                <label for="tipodesdescricao" class="col-sm-2 control-label"><span style="color: red">* </span>Descrição:</label>
                <div class="col-sm-8">
                    <input type="text" required="required" value="<?php echo $this->Dados[0]['tipodesdescricao']?>" class="form-control" id="tipodesdescricao" placeholder="Digite descrição">
                    <input type="hidden" required="required" value="<?php echo $this->Dados[0]['tipodescod']?>" class="form-control" id="tipodescod" >
                </div>
            </div>
            <div class="form-group">
