...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" id="form_culto_editar">
            <div class="form-group">  
                <div class="col-sm-6">
                    <label for="culdescricao" class=" control-label"><span style="color: red">* </span>Descrição:</label>
                     <input type="hidden" value="<?php echo $this->Dados[0]['culcod']?>" id="culcod" >
                    <input type="text" required="required" value="<?php echo $this->Dados[0]['culdescricao']?>" class="form-control" id="culdescricao" placeholder="Digite nome">
                </div>
                <div class="col-sm-4">
                    ...
                    <select  id="culdia_semana" class="form-control">
                        <option value="<?php echo $this->Dados[0]['culdia_semana']?>"><?php echo $this->Dados[0]['culdia_semana']?></option>
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    ...
                    <input type="time" required="required" value="<?php echo $this->Dados[0]['culhorario_inicio']?>" class="form-control" id="culhorario_inicio" >
                </div>
                 <div class="col-sm-4">
                    <label for="culhorario_final" class=" control-label"><span style="color: red">* </span>Horário final:</label>
                    <input type="time" required="required" value="<?php echo $this->Dados[0]['culhorario_fial']?>" class="form-control" id="culhorario_final">
                </div>
            </div>
