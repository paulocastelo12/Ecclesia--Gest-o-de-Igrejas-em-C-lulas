...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" id="form_fornecedor_editar">
            <div class="form-group">
                <label for="fornecod" class="col-sm-2 control-label"><span style="color: red">* </span>CPF/CNPJ:</label>
                <div class="col-sm-8">
                    <input type="text" required="required" value="<?php echo $this->Dados[0]['forneidt']?>" class="form-control" id="forneidt" >
                    <input type="hidden" required="required" value="<?php echo $this->Dados[0]['fornecod']?>" class="form-control" id="fornecod" >
                </div>
            </div>
            <div class="form-group">
                <label for="fornedescricao" class="col-sm-2 control-label"><span style="color: red">* </span>Descrição:</label>
                <div class="col-sm-8">
                    <input type="text" required="required" value="<?php echo $this->Dados[0]['fornedescricao']?>" class="form-control" id="fornedescricao" placeholder="Digite descrição">
                </div>
            </div>
            <div class="form-group">
