...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" id="form_celula_editar">
            <div class="form-group">  
                <div class="col-sm-6">
                    <input type="hidden" value="<?php echo $this->Dados[0]['celcod'] ?>" id="celcod" >
                    <label for="celdescricao"  class=" control-label"><span style="color: red">* </span>Descrição:</label>
                    <input type="text" value="<?php echo $this->Dados[0]['celdescricao'] ?>" class="form-control" id="celdescricao" placeholder="Digite nome">
                </div>
                <div class="col-sm-4">
                    ...
                    <select id="celclassificacao" class="form-control">
                        <option><?php echo $this->Dados[0]['celclassificacao'] ?></option>
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    ...
                    <input type="text" value="<?php echo $this->Dados[0]['celanfitriao'] ?>" class="form-control" id="celanfitriao" >
                </div>
                <div class="col-sm-4">
                    <label for="celmemnome" class=" control-label"><span style="color: red">* </span>Líder:</label>
                    <input type="text" readonly="true" value="<?php echo $this->Dados[0]['memnome'] ?>" class="form-control" id="celmemnome">
                    <input type="hidden" value="<?php echo $this->Dados[0]['memcod'] ?>" readonly="true" class="form-control" id="celmemcod">
                </div>
                <div class="col-sm-4">
            ...
            <div class="modal-body ">
                ...
                <form id="form-pesqLideresCelula">
                    ...
                    <table id="example" class="display" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            foreach ($this->Dados_editar as $membro) {
                                ?>
                                <tr>
                                    <td><?= $membro['memcod'] ?></td>
