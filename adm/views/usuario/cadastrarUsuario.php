...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" id="form_cargo">
            ...
            <div class="form-group">
                <label for="usuemail" class="col-sm-2 control-label">Login:</label>
                <div class="col-sm-8">
                    <input type="email" required="required" class="form-control" id="usuemail" placeholder="exemplo@ecclesia.com">
                </div>
            </div>
            <div class="form-group">
...
<script src="<?php echo URL; ?>assets/js/usuario1.js"></script>